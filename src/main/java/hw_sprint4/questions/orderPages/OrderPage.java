...
public class OrderPage {
    ...
    private final By METRO_STATION = By.xpath("//input[contains(@placeholder,'* Станция метро')]");
    private final By PHONE_NUMBER = By.xpath("//input[contains(@placeholder,'* Телефон: на него позвонит курьер')]");
    private final By NEXT_BUTTON = By.className("Order_NextButton__1_rCA");
    ...
    public void fillInOrderForm(String name, String surname, String address, int metroStationIndex, String proneNumber) {
        ...
        driver.findElement(By.xpath(".//button[contains(@value, '" + metroStationIndex + "')]"));
