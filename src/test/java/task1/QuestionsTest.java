...
import hw_sprint4.questions.Questions;
...
public class QuestionsTest {
    ...
    public QuestionsTest(String question, String answer, boolean result) {
    ...
    public static Object[][] getQuestionAndAnswer() {
        return new Object[][] {
                ...
                {"Самокат приезжает к вам с полной зарядкой. Этого хватает на восемь суток — даже если будете кататься без передышек и во сне. Зарядка не понадобится.", "Самокат приезжает к вам с полной зарядкой. Этого хватает на восемь суток — даже если будете кататься без передышек и во сне. Зарядка не понадобится.\n" +
                        "\n", true},
    ...
    public void questionsTest() {
        ...
        Questions question = new Questions(driver);
        assert assertEquals(, question.openDropdownQuestionsAndCheckAnswers());
